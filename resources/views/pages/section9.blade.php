<div class="sec9pc">
    <img src="{{asset('images/Group 58.png')}}" class="headersec9pc aniUtil_dramatic ani_slideInDown"><br>
    <img src="{{asset('images/Group 701.svg')}}" class="header2sec9pc aniUtil_dramatic ani_slideInDown"><br>
    <div class="mb-4">
...
<div class="sec9mb" id="sec9">
    ...
    <object data="{{asset('images/Group 591.svg')}}" class="header2sec9mb"></object>
    <object data="{{asset('images/Group 671.svg')}}" class="header3sec9mb"></object>
    <object data="{{asset('images/Group 52.svg')}}" class="header3sec9mb"></object>
