<div class="sec5pc">
    <img src="{{asset('images/topbannersec5.png')}}" class="topbannersec5pc">
    <img src="{{asset('images/Tongquan.png')}}" class="tongquanpc aniUtil_dramatic ani_slideInDown">
    <div class="line1sec5pc">
        <div class="line1tongquanpc aniUtil_dramatic ani_slideInLeft">
        ...
        <div class="line2tongquanpc aniUtil_dramatic ani_slideInRight">
    ...
    <img src="{{asset('images/Group 109.png')}}" class="tongquan2pc aniUtil_dramatic ani_slideInDown">
    <div class="line2sec5pc">
        <div class="line3tongquanpc">
            <img src="{{asset('images/Group 117.svg')}}" class="line3dot1pctop aniUtil_dramatic ani_slideInLeft">
            <img src="{{asset('images/Group 120.svg')}}" class="line4dot1pctop aniUtil_dramatic ani_slideInRight"><br>
            <img src="{{asset('images/Group 118.svg')}}" class="line3dot1pc aniUtil_dramatic ani_slideInLeft">
            <img src="{{asset('images/Group 122.svg')}}" class="line4dot1pc aniUtil_dramatic ani_slideInRight"><br>
            <img src="{{asset('images/Group 119.svg')}}" class="line3dot1pc lineBot aniUtil_dramatic ani_slideInLeft">
            <img src="{{asset('images/Group 123.svg')}}" class="line4dot1pc lineBot aniUtil_dramatic ani_slideInRight">
        </div>
    </div>
</div>
